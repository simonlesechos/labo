//CODE DU MENU
	  ...
	  $('.navbar-search-panel input,.navbar-search-panel button').click(function(event){
	  	  event.stopPropagation();
	  });
	...
	/*Survol des li 'large-list' déplient la div 'large-list-container'*/
      ...
      //Hide the menus if visible
		...
		$(function(){
		  ...
		  // Gestion du focus sur l'input de la barre de recherche
		  
		  $('.navbar-form input').focus(function(){
		  	
		    $(this).parents('.navbar-search-panel form').addClass('focused');
		  	
		  });
		  
		  $('.navbar-form input').blur(function(){
		  	
		  	$(this).parents('.navbar-search-panel form').removeClass('focused');
