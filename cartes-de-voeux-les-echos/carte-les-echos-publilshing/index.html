...
<head>
  ...
  <title>Voeux 2015 - LES ECHOS PUBLISHING</title>
...
<div class="carte-bg"></div>
   ...
   <div class="perso-cabinet">
          ...
          <h3><strong>Toute&#160;l'équipe&#160;des</strong> ECHOS&#160;PUBLISHING</h3>
          <br>
     
          <p class="perso-cab-1">vous remercie de votre confiance témoignée</p>
          <p class="perso-cab-2">au cours de l’année écoulée,</p>
          <p class="perso-cab-3">et vous présente ses meilleurs vœux</p>
          <p class="perso-cab-4">pour cette nouvelle année</p>
    ...
    <div class="carte-back">
          ...
          <div class="fdf-container">
              ...
              <div class="text-group-back">
                ...
                <div class="fdf-desc">
                   <p>Nous soutenons l'opération</p><p>" Plus de chances pour l'emploi "</p><p>menée avec la Fondation de France.</p>
                   <br/>
  ...
  <div class="y2015-bas">
    ...
    <div class="carte">
       <div class="perso-face">
          <strong>L'équipe des </strong>Echos Publishing
        </div>
    ...
    <div class="perso-cabinet2">
        <div class="perso2">
          <div class="logo-cabinet">
            <img src="img/logo-les-echos-publishing.jpg"> 
          </div>
         
		  <p>16, rue du Quatre-Septembre</p>
		  <p>75002 Paris</p>
          <p><a class="lienCarte" href="http://www.lesechos-publishing.fr/" >www.lesechos-publishing.fr</a></p>
        </div>
